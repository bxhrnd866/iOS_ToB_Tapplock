...
extension AppDelegate {
    func checkVersion() {
        ...
        //网络请求获取并比较版本信息.
        provider.rx.request(APIServer.appversion)
            .mapObject(APIResponse<AppVersionModel>.self)
            .subscribe(onSuccess: { [weak self] response in
                ...
                if response.data!.supportMinVersion!.compare(app_Version) == .orderedDescending {
                ...
                else if  response.data!.currentVersion!.compare(app_Version) == .orderedDescending {
